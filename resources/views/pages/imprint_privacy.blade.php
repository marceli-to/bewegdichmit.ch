@extends('app')
@section('seo_title', 'Impressum und Datenschutz')
@section('content')
<x-layout.section>
...
<x-layout.section>
  <x-layout.inner class="privacy">
    <div class="max-w-3xl">
      ...
      <p>Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zur Verarbeitung der personenbezogenen Daten per E-Mail an <a href="mailto:hello@bewegdichmit.ch">hello@bewegdichmit.ch</a> zu widerrufen. In einem solchen Fall kann die Konversation nicht fortgeführt werden.</p>
