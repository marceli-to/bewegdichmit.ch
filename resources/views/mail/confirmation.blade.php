<x-mail::message>
  @if ($data->category == 'single')
    <div class="text-base pb-base">
      ...
      Wir bitten dich, den gewählten Betrag von <strong>CHF {{ $data->entry_fee }}</strong> bis zum 25. Mai 2024 mit angefügtem Einzahlungsschein zu begleichen.<br><br>
      Mit deiner Teilnahme trägst du zur Gesundheit unserer Bewohnerinnen und Bewohner bei und unterstützt im Rahmen unseres Spendenprojektes Gesundheit und Fitness unter anderem die Realisierung eines barrierefreien und bedarfsgerechten Fitnessraums im Wagerenhof.<br>Herzlichen Dank!<br><br>
      <strong>Programm</strong><br>
      Gerne begrüssen wir dich am Samstag, 1. Juni 2024 im Wagi-Dorfbüro für den Check-In.<br><br>
      Stiftung Wagerenhof<br>
      Asylstrasse 24<br>
      8610 Uster<br><br>
      Check-In: ab 9.30 Uhr<br>
      Bitte hole deine Startnummer spätestens <strong>30 Minuten vor deiner gewählten Startzeit {{ $data->start_time }} Uhr</strong> im Wagi-Dorfbüro ab.<br><br>
      ...
      Konzert Consalson: 13.00 und 15.00 Uhr<br><br>
  ...
  <div class="text-base pb-base">
    ...
    Wir bitten euch, den gewählten Betrag von <strong>CHF {{ $data->entry_fee }}</strong> bis zum 25. Mai 2024 mit angefügtem Einzahlungsschein zu begleichen.<br><br>
    Mit eurer Teilnahme trägt ihr zur Gesundheit unserer Bewohnerinnen und Bewohner bei und unterstützt im Rahmen unseres Spendenprojektes Gesundheit und Fitness unter anderem die Realisierung eines barrierefreien und bedarfsgerechten Fitnessraums im Wagerenhof.<br>Herzlichen Dank!<br><br>
    <strong>Programm</strong><br>
