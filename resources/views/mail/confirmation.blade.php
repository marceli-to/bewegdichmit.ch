<x-mail::message>
  @if ($data->category == 'single')
    <div class="text-base pb-base">
      ...
      Bitte hole deine Startnummer im Wagi-Dorfbüro spätestens <strong>30 Minuten vor deiner gewählten Startzeit ab. Du startest in der Läufergruppe um: {{ $data->start_time }} Uhr.</strong><br><br>
  ...
  <div class="text-base pb-base">
    ...
    Vielen Dank für eure Teilnahme als <strong>Familie/Gruppe von {{ $data->number_of_members }}</strong> Personen. Wir freuen uns sehr, euch bald bei uns im Wagerenhof zu begrüssen. Gemeinsam umrunden wir das Wagi-Quartier (ca. 500m) und geniessen einen sportlichen Tag mit allerlei Attraktionen, einer vielseitigen Foodmeile und Live Musik.<br><br>
